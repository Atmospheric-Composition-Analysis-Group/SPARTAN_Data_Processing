...
diary  (sprintf('%s/Public_Data/Data_Processing_Records/Time_Resolved_PM25/%s_Time_Resolved_PM25_Record.txt',direc,datestr(now,'yyyy-mm-dd-HHMMSS')))
fprintf('%s \n', datestr(now))
...
%     end
   ...
   % end
    ...
    fprintf(fileID,'File Updated: %s, %s %g \n',datestr(now), data_version,deriv_thres);
